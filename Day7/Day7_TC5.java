    ...
    public void TestCase_03() throws InterruptedException {
        ...
        try {
            ...
            if (title1.equalsIgnoreCase(expectedTitle1)) {
                ...
                Thread.sleep(3000);
                dr.findElement(By.xpath("//*[@id=\"8469f0c3-e08f-4343-9756-ce0390b0d581\"]"))
                        .sendKeys("mydomain");
                dr.findElement(By.xpath("//*[@id=\"id-1467954b-c5e3-4b0c-9046-9fc94d8ca892\"]/section/div/div/section/div/div[1]/div/div/form/div/button"))
                        .click();
                Thread.sleep(2000);
                dr.findElement(By.xpath("//*[@id=\"id-1467954b-c5e3-4b0c-9046-9fc94d8ca892\"]/section/div/div/section/div/div[1]/div/div/form/div/button"))
                        .click();
                Thread.sleep(3000);
                dr.findElement(By.xpath("//*[@id=\"search-app\"]/div/div/div/div[3]/div[1]/div[2]/div[1]/div[2]/div[5]/div/div/div[2]/button"))
                        .click();
                Thread.sleep(2000);
                dr.findElement(By.xpath("//*[@id=\"search-app\"]/div/div/div/div[3]/div[1]/div[2]/div[1]/div[2]/div[4]/div[2]/div[2]/span"))
                        .isDisplayed();
            } else {
                dr.getCurrentUrl();
            }
